...
const { getPollData, getAllPhoneNumbersForPoll } = require(process.env.DB_GET_LOCATION);
...
const smsOnPollCompletion = function (poll_id) {
	...
	// const smsString = `A poll you voted on has been completed`;
}

smsOnPollCompletion(4);
